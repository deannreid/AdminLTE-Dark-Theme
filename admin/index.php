...
<span class="queries-permitted"></span> <span class="queries-blocked"></span> <span class="graphs-grid"></span> <span class="graphs-ticks"></span> 
...
<div class="row">
  <div class="col-lg-3 col-sm-6"> 
    ...
    <div class="small-box bg-green no-user-select" id="total_queries" title="only A + AAAA queries">
      <div class="inner">
        <h3 class="small-text bgt-green"><span id="dns_queries_today">---</span></h3>
  ...
  <div class="col-lg-3 col-sm-6"> 
    <!-- small box -->
    <div class="small-box bg-orange no-user-select">
      <div class="inner">
        <h3 class="small-text bgt-orange"><span id="percentage_blocked_today">---</span></h3>
        <p>Percent Blocked</p>
      </div>
      <div class="icon icon-orange"> <i class="fas fa-chart-pie"></i> </div>
    </div>
  </div>
  <!-- ./col -->
  <div class="col-lg-3 col-sm-6"> 
...
<div class="row">
  <div class="col-md-12">
    <div class="box" id="queries-over-time">
      ...
      <div class="overlay"> <i class="fa fa-sync fa-spin"></i> </div>
      <!-- /.box-body --> 
    </div>
  </div>
</div>
